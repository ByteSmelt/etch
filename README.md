<picture>
  <source media="(prefers-color-scheme: dark)" srcset="logo_dark.png" width="50%">
  <source media="(prefers-color-scheme: light)" srcset="logo_light.png" width="50%">
  <img alt="Fallback image description" src="logo_light.png" width="50%">
</picture>
...
[![Tests](https://github.com/ByteSmelt/etch/actions/workflows/test.yml/badge.svg)](https://github.com/ByteSmelt/etch/actions/workflows/test.yml)
...
fn calculate_damage(base: int, armor: int) {
